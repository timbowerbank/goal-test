...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('family_friends', function (Blueprint $table) {
            ...
            $table->string('family_friend_status', length:20)->default('unverified')->index();
            $table->timestamp('family_friend_status_updated_at')->nullable();
            $table->foreignId('family_friend_status_updated_by_user_id')->nullable()->constrained('users', 'id')->onDelete('restrict');
            $table->timestamps();
        });
    }
