...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('managers', function (Blueprint $table) {
            ...
            $table->string('manager_status', length: 20)->default('unverified')->index();
            $table->timestamp('manager_status_updated_at')->nullable();
            $table->foreignId('manager_status_updated_by')->nullable()->constrained('users', 'id')->onDelete('restrict');
            $table->timestamps();
        });
    }
